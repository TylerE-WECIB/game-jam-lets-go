...
def main_space():
    player_health, player_sanity, player_position, player_money, player_status = 10, 10, 0, 20, True
    map_open, bad_ending, grocery = False, True, False
    inventory, room, fridge, cart = [], ['weapon', 'pizza', 'wallet'], ['cheese', 'pizza'], []
    bread, milk, cheese, yogurt, chicken, eggs = 4, 4, 3, 1, 5, 2
    grocery_list = ['bread', 'milk', 'eggs', 'cheese', 'yogurt']
    grocery_store = [['chicken', 'turkey', 'filet mignon'], [bread, milk, '2% milk', eggs, cheese, yogurt]]
